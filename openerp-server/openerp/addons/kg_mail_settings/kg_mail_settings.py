...
class kg_mail_settings(osv.osv):
	...
	_columns = {
		...
		'entry_id':fields.one2many('kg.mail.settings.line','line_entry',readonly=False),
...
class kg_mail_settings_line(osv.osv):
	_name = "kg.mail.settings.line"
	_columns = {
			
			'line_entry':fields.many2one('kg.mail.settings','Line Entry'),
