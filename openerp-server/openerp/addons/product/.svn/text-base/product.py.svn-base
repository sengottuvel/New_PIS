...
class product_uom(osv.osv):
	...
	def _compute_qty(self, cr, uid, from_uom_id, qty, to_uom_id):
		if not from_uom_id or not qty or not to_uom_id:
			return qty
		print "from_uom_id",from_uom_id
		print "from_uom_id",to_uom_id
		print "from_uom_id",self
	...
	def _compute_qty_obj(self, cr, uid, from_unit, qty, to_unit, context=None):
		...
		print "to_unit.category_id.id",to_unit.category_id.id
		print "qty",qty
...
class product_template(osv.osv):
	...
	def _default_category(self, cr, uid, context=None):
		...
		try:
			...
			res = False
		print "ccccccccccressssssssss",res
		return res
