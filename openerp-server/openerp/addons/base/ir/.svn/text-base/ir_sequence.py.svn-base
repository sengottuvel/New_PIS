...
class ir_sequence(openerp.osv.osv.osv):
    ...
    _columns = {
        ...
        'number_next_actual': openerp.osv.fields.function(_get_number_next_actual, fnct_inv=_set_number_next_actual, type='integer',
					required=True, string='Next Number', help='Next number that will be used. This number can be incremented frequently so the displayed value might already be obsolete'),
        ...
        'reset_sequence': openerp.osv.fields.selection([('monthly_reset','Monthly Reset'),('yearly_reset','Yearly Reset')],'Reset Sequence'),
    }
    _defaults = {
