...
class res_company(osv.osv):
	...
	_columns = {
		'name': fields.char('Company Name', size=128, required=True, store=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'parent_id': fields.many2one('res.company', 'Parent Company', select=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'child_ids': fields.one2many('res.company', 'parent_id', 'Child Companies',readonly=True, states={'waiting':[('readonly',False)]}),
		'partner_id': fields.many2one('res.partner', 'Partner', required=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'rml_header': fields.text('RML Header', required=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'rml_header1': fields.char('Company Tagline', size=200, help="Appears by default on the top right corner of your printed documents (report header).",readonly=True, states={'waiting':[('readonly',False)]}),
		'rml_header2': fields.text('RML Internal Header', required=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'rml_header3': fields.text('RML Internal Header for Landscape Reports', required=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'rml_footer': fields.text('Report Footer', help="Footer text displayed at the bottom of all reports.",readonly=True, states={'waiting':[('readonly',False)]}),
		'rml_footer_readonly': fields.related('rml_footer', type='text', string='Report Footer', readonly=True),
		'custom_footer': fields.boolean('Custom Footer', help="Check this to define the report footer manually.  Otherwise it will be filled in automatically.",readonly=True, states={'waiting':[('readonly',False)]}),
		'logo': fields.related('partner_id', 'image', string="Logo", type="binary",readonly=True, states={'waiting':[('readonly',False)]}),
		...
		'currency_id': fields.many2one('res.currency', 'Currency', required=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'currency_ids': fields.one2many('res.currency', 'company_id', 'Currency',readonly=True, states={'waiting':[('readonly',False)]}),
		'user_ids': fields.many2many('res.users', 'res_company_users_rel', 'cid', 'user_id', 'Accepted Users',readonly=True, states={'waiting':[('readonly',False)]}),
		'account_no':fields.char('Account No.', size=64,readonly=True, states={'waiting':[('readonly',False)]}),
		'street': fields.function(_get_address_data, fnct_inv=_set_address_data, size=128, type='char', string="Street", multi='address',readonly=True, states={'waiting':[('readonly',False)]}),
		'street2': fields.function(_get_address_data, fnct_inv=_set_address_data, size=128, type='char', string="Street2", multi='address',readonly=True, states={'waiting':[('readonly',False)]}),
		'zip': fields.function(_get_address_data, fnct_inv=_set_address_data, size=24, type='char', string="Zip", multi='address',readonly=True, states={'waiting':[('readonly',False)]}),
		'city': fields.many2one('res.city','CITY',readonly=True, states={'waiting':[('readonly',False)]}),
		'state_id': fields.many2one('res.country.state','State',readonly=True, states={'waiting':[('readonly',False)]}),
		'bank_ids': fields.one2many('res.partner.bank','company_id', 'Bank Accounts', help='Bank accounts related to this company',readonly=True, states={'waiting':[('readonly',False)]}),
		'country_id': fields.many2one('res.country','Country',readonly=True, states={'waiting':[('readonly',False)]}),
		'email': fields.function(_get_address_data, fnct_inv=_set_address_data, size=64, type='char', string="Email", multi='address',readonly=True, states={'waiting':[('readonly',False)]}),
		'phone': fields.function(_get_address_data, fnct_inv=_set_address_data, size=64, type='char', string="Phone", multi='address',readonly=True, states={'waiting':[('readonly',False)]}),
		'fax': fields.function(_get_address_data, fnct_inv=_set_address_data, size=64, type='char', string="Fax", multi='address',readonly=True, states={'waiting':[('readonly',False)]}),
		'website': fields.related('partner_id', 'website', string="Website", type="char", size=64,readonly=True, states={'waiting':[('readonly',False)]}),
		'vat': fields.related('partner_id', 'vat', string="Tax ID", type="char", size=32,readonly=True, states={'waiting':[('readonly',False)]}),
		'company_registry': fields.char('Company Registry', size=64,readonly=True, states={'waiting':[('readonly',False)]}),
		'paper_format': fields.selection([('a4', 'A4'), ('us_letter', 'US Letter')], "Paper Format", required=True,readonly=True, states={'waiting':[('readonly',False)]}),
		
		
		### Code Added by Sangeetha ###
		
		'code': fields.char('Code', size=128, required=True, store=True,readonly=True, states={'waiting':[('readonly',False)]}),
		'tin_no': fields.char('TIN NO', size=128,readonly=True, states={'waiting':[('readonly',False)]}),
		'vat_no': fields.char('VAT NO', size=128,readonly=True, states={'waiting':[('readonly',False)]}),
		'cst_no': fields.char('CST NO', size=128,readonly=True, states={'waiting':[('readonly',False)]}),
		'cin_no': fields.char('CIN NO', size=128,readonly=True, states={'waiting':[('readonly',False)]}),
		'active':fields.boolean('Active',readonly=True, states={'waiting':[('readonly',False)]}),
		'creation_date':fields.datetime('Creation Date',readonly=True),
		'same_as_del_add':fields.boolean('Same',readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_street': fields.char(size=128, string="Street",readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_street2': fields.char(size=128, string="Street2",readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_zip': fields.char(size=24, string="ZIP",readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_city': fields.many2one('res.city','CITY',readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_state_id': fields.many2one('res.country.state','State',readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_country_id': fields.many2one('res.country','Country',readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_phone': fields.char(size=64, type='char', string="Phone",readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_fax': fields.char(size=64, type='char', string="Fax",readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_email': fields.char(size=64, type='char', string="Email",readonly=True, states={'waiting':[('readonly',False)]}),
		'bill_website': fields.related('partner_id', 'website', string="Website", type="char", size=64,readonly=True, states={'waiting':[('readonly',False)]}),
		'state': fields.selection([('waiting', 'Waiting for Approval'), ('approved', 'Approved')], "Status", readonly=True),
		'division': fields.char('Division', size=250,readonly=True, states={'waiting':[('readonly',False)]}),
	...
	def onchange_billing_address(self, cr, uid, ids, same_as_del_add, street,street2,city,state_id,country_id,zip,phone,fax,email,context=None):
		print "Calling onchange_billing_address"
		value = {'bill_street':'','bill_street2':'','bill_zip':'',
						'bill_city':'','bill_state_id':'','bill_country_id':''}
		print "same_as_del_add",same_as_del_add,street,street2,city,state_id,country_id
