...
class kg_indent_to_invoice_tat_report(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		super(kg_indent_to_invoice_tat_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_kg_indent_to_invoice_tat_report', 'res.users', parser=kg_indent_to_invoice_tat_report)
