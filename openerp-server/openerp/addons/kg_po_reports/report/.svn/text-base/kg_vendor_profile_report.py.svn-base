...
class kg_vendor_profile_report(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		super(kg_vendor_profile_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_kg_vendor_profile_report', 'res.users', parser=kg_vendor_profile_report)
