...
class kg_open_advance_wizard(osv.osv_memory):
	_name = "kg.open.advance.wizard"
	_description = "Open advance Details"
	...
	def create_report(self, cr, uid, ids, context={}):
		...
		return {
			...
			'report_name'   : 'jasper_kg_open_advance_report',
			'datas': {
