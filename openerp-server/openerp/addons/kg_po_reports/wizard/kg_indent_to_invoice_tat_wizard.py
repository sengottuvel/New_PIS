...
class kg_indent_to_invoice_tat_wizard(osv.osv_memory):
	_name = "kg.indent.to.invoice.tat.wizard"
	_description = "Indent To Invoice TAT Report"
	...
	def create_report(self, cr, uid, ids, context={}):
		...
		return {
			...
			'report_name'   : 'jasper_kg_indent_to_invoice_tat_report',
			'datas': {
...
kg_indent_to_invoice_tat_wizard()
