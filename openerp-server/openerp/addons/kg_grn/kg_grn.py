...
class kg_stock_move(osv.osv):
   ...
   'location_dest_id': fields.many2one('stock.location', 'Destination Location', required=True,
    ...
    'categ1': fields.many2one('product.category', 'Category1'),
    'categ2': fields.many2one('product.category', 'Category2'),
    'categ3': fields.many2one('product.category', 'Category3'),
    'categ4': fields.many2one('product.category', 'Category4'),
    'categ5': fields.many2one('product.category', 'Category5'),
    'categ6': fields.many2one('product.category', 'Category6'),
    ...
    'price_tax': fields.float('Price With Tax', readonly=True),
