...
class kg_grn_tat_wizard(osv.osv_memory):
	_name = "kg.grn.tat.wizard"
	_description = "GRN TAT"
	...
	_columns = {
				...
				'status': fields.selection([('done', 'Approved'),('inv','Invoiced')], "Status"),
	...
	def create_report(self, cr, uid, ids, context={}):
		...
		return {
			...
			'report_name'   : 'jasper_kg_grn_tat_report',
			'datas': {
