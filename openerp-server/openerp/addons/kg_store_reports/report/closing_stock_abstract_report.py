...
class closing_stock_abstract_report(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		super(closing_stock_abstract_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_closing_stock_abstract_report', 'res.users', parser=closing_stock_abstract_report)
