...
class product_product(osv.osv):
	...
	def _stock_move_count(self, cr, uid, ids, field_name, arg, context=None):
		print "_stock_move_count-----------from stock product.py"
	...
	def get_product_accounts(self, cr, uid, product_id, context=None):
		print "get_product_accounts-----------from stock product.py"
	...
	def do_change_standard_price(self, cr, uid, ids, datas, context=None):
		print "do_change_standard_price-----------from stock product.py"
	...
	def view_header_get(self, cr, user, view_id, view_type, context=None):
		print "view_header_get-----------from stock product.py"
	...
	def get_product_available(self, cr, uid, ids, context=None):
		print "get_product_available-----------from stock product.py"
		...
		print "what whwhwhwhwhwhwhwhwhwwwhhw", what
		if 'in' in what:
		...
		if 'out' in what:
			...
			print "result 222222222222{}{}{}{}{}{{{{}}{}{}", results2
		...
		for amount, prod_id, prod_uom in results2:
			print "sangeetha-----------------prod_uom--------------->>>",prod_uom
			print "sangeetha-----------------prod_id--------------->>>",prod_id
			print "sangeetha-----------------ffff--------------->>>",product2uom[prod_id]
			print "sangeetha-----------------prod_uom--------------->>>",uoms_o[prod_uom]
			amount = uom_obj._compute_qty_obj(cr, uid, uoms_o[prod_uom], amount,
					uoms_o[context.get('uom', False) or product2uom[prod_id]], context=context)
			res[prod_id] -= amount
		return res
	...
	def _product_available(self, cr, uid, ids, field_names=None, arg=False, context=None):
		print "_product_available-----------from stock product.py///////////////////////////////////////////////////////", ids
		...
		for f in field_names:
			print "fffffffffffffffffffffffffffffffffffffffffff",f
			c = context.copy()
			print "ccccccccccccccccccccccccccccccccccccccccccccccc",c
			if f == 'qty_available':
	...
	def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
		print "fields_view_get-----------from stock product.py"
